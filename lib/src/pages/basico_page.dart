  ...
  Widget _crearImagen(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Image(
          image: NetworkImage('https://p16-sign-va.tiktokcdn.com/tos-maliva-p-0068/e804e2efd5d1494aa0115c1822a6ce40_1638330212~tplv-tiktokx-share-play.jpeg?x-expires=1646326800&x-signature=0FOZRFrUOzkdSIV0advwdZalhh4%3D'),
          height: 200.0,
          fit: BoxFit.cover,
        ),
      ),
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  Text('Spiderman', style: estiloTitulo ),
                  SizedBox( height: 7.0 ),
                  Text('Spiderman', style: estiloSubTitulo ),
                ],
              ),
            ),
